...
void Graphics::initGraphics() {
    this->_window = SDL_CreateWindow(
        "Plants Vs. Zombies", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 0,
        0,
...
int Graphics::getTargetFPS() const { return this->_targetFPS; }

int Graphics::getFrameDuration() const { return this->_frameDuration; }
